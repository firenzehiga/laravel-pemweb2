    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                @if (Route::has('login'))
                @auth
                <li class="sidebar-nav-item"><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>
                @else
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1">E-Learning</h1>
                <h3 class="mb-5"><em>Sistem Pembelajaran Online melalui Website</em></h3>
                ...
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="{{ asset('LandingPage') }}/assets/img/portfolio-2.jpg" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="{{ asset('LandingPage') }}/assets/img/portfolio-3.jpg" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="{{ asset('LandingPage') }}/assets/img/portfolio-4.jpg" alt="..." />
                        </a>
                    </div>
                </div>
            </div>
